...
public class end extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb = new DatabaseHelper(end.this, "cal.db", null, 1);
        tamt = (TextView) findViewById(R.id.textView2);
        dis = (EditText) findViewById(R.id.editText);
        pro = (Button) findViewById(R.id.button17);
        Bundle bundle = getIntent().getExtras();
        assert bundle != null;
        name = bundle.getString("haa");
        det = bundle.getString("haa2");
        fla = bundle.getString("haa3");
        am = bundle.getString("haa4");
        tamt.setText(am);
        fad();
    }
